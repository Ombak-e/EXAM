...
public class Login extends javax.swing.JFrame {
    ...
    public static boolean sir(String user, String pass){        
        try{
            String query = "SELECT * FROM dehara  WHERE u_user = '" + user + "' AND u_password = '" + pass + "'";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LOGIN DASBOARD");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (sir(txtUsername.getText(), txtPassword.getText())){
    ...
    private boolean Sir(String text, String text0) {
